...
const PUSH_MESSAGES: Record<string, { title: string; body: string }> = {
  ...
  mailbox_open: { title: '📮 半日达', body: '新一场已开启，写点什么给 ta 吧～' },
  mailbox_written: { title: '💌 半日达', body: '{name} 寄出了一封信，等送达时间' },
  mailbox_countdown_15min: { title: '💌 半日达', body: '15 分钟后送达本场的信！' },
  mailbox_reveal: { title: '📮 半日达', body: '本场的信已送达！快来看看 💌' },
